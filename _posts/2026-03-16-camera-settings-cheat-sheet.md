---
layout: post
title: "Camera Settings Cheat Sheet for Every Shooting Scenario"
description: "A camera settings cheat sheet for every common filming scenario. Quick-reference guide for ISO, shutter speed, aperture, and white balance in any lighting condition."
date: 2026-03-16
categories: [camera-settings]
tags: [camera settings cheat sheet, camera settings guide, filming settings, exposure guide, quick reference]
---
...
Bookmark this page. Pull it up on set. And if you want the full coaching breakdown behind any of these recommendations, try [FrameCoach](https://framecoach.io) for real-time, scenario-specific guidance.
...
For those situations, you need contextual coaching, not a chart. [FrameCoach](https://framecoach.io) handles exactly these edge cases — you describe the specific scenario and get tailored guidance with explanations of the trade-offs.

Use this cheat sheet as your baseline. Use [FrameCoach](https://framecoach.io) when the baseline doesn't quite fit. Between the two, you'll have the camera settings locked for any shoot.
