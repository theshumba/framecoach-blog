---
layout: post
title: "How to Set Camera Settings for Film: A Beginner's Complete Guide"
description: "Learn how to set camera settings for film. Master ISO, shutter speed, aperture, white balance, and frame rate with this complete beginner's guide."
date: 2026-02-01
categories: [camera-settings]
tags: [camera settings for film, beginner camera guide, filmmaking settings, exposure for video]
---
...
1. **Frame rate** — How many images per second
2. **Shutter speed** — How long each image is exposed
3. **Aperture** — How much light the lens lets in
4. **ISO** — How sensitive the sensor is to light
5. **White balance** — What "white" looks like in your scene
...
[Read our full shutter speed guide](/framecoach-blog/shutter-speed-for-filmmaking/) for more detail.
...
[Deep dive on aperture](/framecoach-blog/aperture-for-cinematic-look/)
...
[Full ISO guide](/framecoach-blog/iso-settings-for-video/)
...
[White balance deep dive](/framecoach-blog/white-balance-for-filmmaking/)

## Putting It All Together: A Workflow

Here's the order to set your camera on any shoot:

1. **Frame rate** → 24fps (unless you have a specific reason not to)
2. **Shutter speed** → Double the frame rate (1/50 for 24fps)
3. **White balance** → Match your lighting (5600K daylight, 3200K tungsten)
4. **Aperture** → Set for your desired depth of field
...
If you want real-time guidance through this process on set, [FrameCoach](https://framecoach.io) is a filmmaker app that coaches you through these decisions as you shoot — so you spend less time in menus and more time creating.
